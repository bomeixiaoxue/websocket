// function NoHtml(a) {
//     return -1 == a.indexOf("img.t.sinajs.cn") && (a = a.replace(/({|})/g, ""),
//     a = a.replace(/</g, "&lt;"),
//     a = a.replace(/>/g, "&gt;")),
//     a
// }
...
//         isopenEmoji ? (isopenEmoji = !1,
//         $("#emoji").popover("hide")) : (isopenEmoji = !0,
//         $("#emoji").popover("show"))
//     })
// }
...
//     "" != a && (ws && 1 == ws.readyState ? (ws.send(a),
//     output(NoHtml(chg_emoji(a)), 1),
//     $("#inp_send").val("")) : alert("连接已经断开！"))
// }
// function chg_emoji(a) {
//     var c, b = a.match(/\[.*?]/gi);
//     if (b)
//         for (c = 0; c < b.length; c++)
//             a = a.replace(b[c], emoji[b[c]] ? "<img src='" + emoji[b[c]] + "' />" : b[c]);
//     else
...
//                     U(d, !0),
//                     e && (n = G(d),
//                     n && typeof n.SetVariable != a && (f.success = !0,
//                     f.ref = n),
//                     e(f))
//     }
//     function G(c) {
//         var f, d = null, e = P(c);
//         return e && "OBJECT" == e.nodeName && (typeof e.SetVariable != a ? d = e : (f = e.getElementsByTagName(b)[0],
//         f && (d = f))),
//         d
//     }
//     function H() {
...
//         k = "MMredirectURL=" + ("" + h.location).replace(/&/g, "%26") + "&MMplayerType=" + j + "&MMdoctitle=" + i.title,
...
//         else if (d = a.getElementsByTagName(b)[0],
//         d && (e = d.childNodes))
//             for (f = e.length,
//             g = 0; f > g; g++)
...
//     function T(c, d, e, f) {
//         var g, h, j;
//         y.ie && y.mac || (g = i.getElementsByTagName("head")[0],
...
//             "complete" == i.readyState && (i.detachEvent(g, arguments.callee),
//             A())
//         }),
//         h == top && function() {
//             if (!t) {
...
//         }()),
//         y.wk && function() {
//             return t ? void 0 : /loaded|complete/.test(i.readyState) ? (A(),
//             void 0) : (setTimeout(arguments.callee, 0),
//             void 0)
//         }(),
//         C(A)))
//     }(),
...
//                 id: d
//             };
//             y.w3 && !(y.wk && y.wk < 312) && c && d && e && f && g ? (U(d, !1),
//             B(function() {
//                 var n, o, p, q, r, s;
//                 if (e += "",
//                 f += "",
...
//             if (u) {
//                 var a = P(f);
//                 a && p && (a.parentNode.replaceChild(p, a),
//                 q && (U(q, !0),
...
//             return window.WebSocket = MozWebSocket,
//             void 0
//     }
//     var a;
...
//         error: function() {}
//     },
//     swfobject.getFlashPlayerVersion().major < 10 ? (a.error("Flash Player >= 10.0.0 is required."),
//     void 0) : ("file:" == location.protocol && a.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."),
...
//         return 0 > b ? !0 : (this.bufferedAmount += b,
//         !1)
//     }
//     ,
...
//         void 0) : (this.readyState != WebSocket.CLOSED && this.readyState != WebSocket.CLOSING && (this.readyState = WebSocket.CLOSING,
...
//         var b, c;
//         if ("readyState"in a && (this.readyState = a.readyState),
//         "protocol"in a && (this.protocol = a.protocol),
//         "open" == a.type || "error" == a.type)
...
//                 return a.error("[WebSocket] set WEB_SOCKET_SWF_LOCATION to location of WebSocketMain.swf"),
//                 void 0;
//             window.WEB_SOCKET_SUPPRESS_CROSS_DOMAIN_SWF_ERROR || WEB_SOCKET_SWF_LOCATION.match(/(^|\/)WebSocketMainInsecure\.swf(\?.*)?$/) || !WEB_SOCKET_SWF_LOCATION.match(/^\w+:\/\/([^\/]+)/) || (b = RegExp.$1,
//             location.host != b && a.error("[WebSocket] You must host HTML and WebSocketMain.swf in the same host ('" + location.host + "' != '" + b + "'). " + "See also 'How to host HTML file and SWF file in different domains' section " + "in README.md. If you use WebSocketMainInsecure.swf, you can suppress this message " + "by WEB_SOCKET_SUPPRESS_CROSS_DOMAIN_SWF_ERROR = true;")),
//             c = document.createElement("div"),
//             c.id = "webSocketContainer",
//             c.style.position = "absolute",
//             WebSocket.__isFlashLite() ? (c.style.left = "0px",
//             c.style.top = "0px") : (c.style.left = "-100px",
//             c.style.top = "-100px"),
...
//             var b, c;
//             try {
//                 for (b = WebSocket.__flash.receiveEvents(),
//                 c = 0; c < b.length; ++c)
...
//         var c, d, e, b = $(this)[0];
//         document.selection ? (this.focus(),
//         sel = document.selection.createRange(),
//         sel.text = a,
//         this.focus()) : b.selectionStart || "0" == b.selectionStart ? (c = b.selectionStart,
//         d = b.selectionEnd,
//         e = b.scrollTop,
...
//         return 13 == a.keyCode && a.ctrlKey ? ($("#btn_send").trigger("click"),
//         !1) : void 0
//     })
// });
